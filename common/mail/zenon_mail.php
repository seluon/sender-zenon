            ...
            <tr>
                <td valign="top" style="padding:9px" class="mcnImageBlockInner">
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; width: 61px;">
                                
                                    <a href="https://www.zenon.net" title="Зенон Н.С.П." class="" target="_blank">
                                        <img align="left" alt="" src="<?= $message->embed($logo); ?>" width="61" style="max-width:61px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                    </a>
                                
                            </td>
                            <td style="text-align: left;"><b>Зенон Н.С.П.</b>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Подробнее" href="https://www.zenon.net/actions/30-60-90/" target="_blank" style="font-weight: bold;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Подробнее</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<table align="right" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardBottomContent" width="100%">
    <tbody><tr>
        <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
            ...
            <a href="https://www.zenon.net/actions/30-60-90/" title="" class="" target="_blank">
            

            <img alt="" src="<?= $message->embed($sale_pic); ?>" width="264" style="max-width:279px;" class="mcnImage">
            </a>
	...
	<tbody>
		...
		<tr>
			<td style="-webkit-font-smoothing: subpixel-antialiased; padding-right: 14px;"><img alt="" height="27" src="<?= $message->embed($ico_hend); ?>" width="26"></td>
			<td style="-webkit-font-smoothing: subpixel-antialiased; padding-bottom: 7px;">
			<div style="-webkit-font-smoothing: subpixel-antialiased; color: #666666; font-family: Arial; font-size: 15px; font-weight: 400; line-height: 18px; padding-bottom: 7px;">Акция действительна также при смене тарифного плана линейки "Зенон" с меньшего на больший c годовой оплатой и при переходе с помесячной на годовую оплату текущего тарифа.**</div>
			</td>
		</tr>
		<tr>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #666666;font-size: 11px;">
                        
                            <div style="text-align: left;">**Акция не распространяется на &nbsp;переход с помесячной на годовую оплату тарифного плана Зенон-210.</div>
