                    ...
                    <table width="100%" cellpadding="0" bgcolor="#ffffff" style="background: #ffffff; border-collapse: collapse;">
                        <tr>
                            <td style="-webkit-font-smoothing: subpixel-antialiased; padding: 15px 20px 0 20px;">
                                <div style="-webkit-font-smoothing: subpixel-antialiased; color: #666666; font-family: Arial; font-size: 16px; font-weight: 400; line-height: 22px; padding-bottom: 12px;">
                                    Уважаемый Абонент!
                                </div>
                                <div style="-webkit-font-smoothing: subpixel-antialiased; color: #666666; font-family: Arial; font-size: 16px; font-weight: 400; line-height: 19px; padding-bottom: 15px;">
                                ...
                                Специальное осеннее предложение - больше хостинга за те же деньги!</div>
                                ...
                                <![endif]--><a href="https://www.zenon.net/actions/30-60-90/" style="-webkit-text-size-adjust: none; background-color: rgb(126, 182, 201); border: 1px solid rgb(126, 182, 201); border-radius: 4px; color: #ffffff; display: inline-block; font-family: Arial; font-size: 16px; font-weight: 700; line-height: 40px; mso-hide: all; text-align: center; text-decoration: none; width: 260px;">Подробнее</a>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td style="-webkit-font-smoothing: subpixel-antialiased; padding: 15px 20px 0 20px;">
                                ...
                                <table style="border-collapse: collapse;">
                                    <tr>
                                        <td style="-webkit-font-smoothing: subpixel-antialiased;"><img style="margin-right: 14px" src="<?= $message->embed($ico_symb); ?>" width="24" height="24" alt=""></td>
                                    ...
                                    <tr>
                                        <td style="-webkit-font-smoothing: subpixel-antialiased;"><img style="margin-right: 14px" src="<?= $message->embed($ico_hend); ?>" width="26" height="27" alt=""></td>
                                        <td style="-webkit-font-smoothing: subpixel-antialiased;">
                                            <div style="-webkit-font-smoothing: subpixel-antialiased; color: #666666; font-family: Arial; font-size: 15px; font-weight: 400; line-height: 18px; padding-bottom: 7px;">
                                ...
                                оплату текущего тарифа.**
                                    ...
                                    <tr>
                                        <td style="-webkit-font-smoothing: subpixel-antialiased;"><img style="margin-right: 14px" src="<?= $message->embed($ico_shield); ?>" width="26" height="30" alt=""></td>
                                        <td style="-webkit-font-smoothing: subpixel-antialiased;">
                                            <div style="-webkit-font-smoothing: subpixel-antialiased; color: #666666; font-family: Arial; font-size: 15px; font-weight: 400; line-height: 18px; padding-bottom: 7px;">
                                ...
                                <div style="-webkit-font-smoothing: subpixel-antialiased; color: #666666; font-family: Arial; font-size: 11px; font-weight: 400; line-height: 22px; padding-bottom: 12px;">
